...
/**
 * @author xiangyao
 * @Title: NineGridLayout
 * @Package com.yizhilu.widget
 * @Description: 基于 { a href="https://github.com/HMY314/NineGridLayout"}
 *
 * @date 2017/8/26 20:01
 */
public abstract class NineGridLayout extends ViewGroup {
    ...
    private void refresh() {
        ...
        * **/
        ...
        int size = mUrlList.get(0).equals("") == true ? 0 : getListSize(mUrlList);
        if (size > 0) {
            setVisibility(VISIBLE);
        } else {
            setVisibility(GONE);
