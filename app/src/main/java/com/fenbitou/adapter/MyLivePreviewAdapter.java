...
import com.fenbitou.adapter.viewholder.MyLivePreviewViewHolder;
...
public class MyLivePreviewAdapter extends BaseAdapter<EntityCourse>{
    ...
    public MyLivePreviewAdapter(Context context, List<EntityCourse> mList) {
        super(context, mList);
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        MyLivePreviewViewHolder holder=null;
        if(convertView==null){
            holder=new MyLivePreviewViewHolder();
            convertView = LayoutInflater.from(context).inflate(R.layout.item_my_live_preview, null);
            ...
            holder = (MyLivePreviewViewHolder) convertView.getTag();
        }
        if(0==position){
